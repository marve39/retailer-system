 ...
 */
@Transactional
public interface InvoiceDetailRepository extends CrudRepository<InvoiceDetail, String> {
 ...
 //   public List<GeneralEntity> findEntity(@Param("status") String status, @Param("title") String title);
    ...
    @Query("SELECT invoiceDetail FROM InvoiceDetail invoiceDetail")
    public List<InvoiceDetail> findAllInvoiceDetail(Pageable pageable);
